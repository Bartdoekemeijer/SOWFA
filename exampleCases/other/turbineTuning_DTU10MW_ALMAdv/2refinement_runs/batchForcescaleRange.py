...
templateDirectory = "/home/bmdoekemeijer/OpenFOAM/bmdoekemeijer-2.4.0/simulationCases/10MW_2refinements_runs/10MW_2refinements_dt0.20_template"
mainDestDirectory = "/home/bmdoekemeijer/OpenFOAM/bmdoekemeijer-2.4.0/simulationCases/10MW_2refinements_runs/runs"
...
for forcescale in [1.15]:
    for kfactor in [0.8, 1.0, 1.15, 1.3, 1.5]:
        folderName = "10MW_2refinements_dt0.20_"+"k"+str(kfactor)+"_F"+str(forcescale)
        jobName = folderName
