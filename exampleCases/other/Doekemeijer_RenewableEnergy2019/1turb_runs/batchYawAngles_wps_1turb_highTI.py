...
templateDirectory = "/home/bmdoekemeijer/OpenFOAM/bmdoekemeijer-2.4.0/simulationCases/RE2019/template_wps_1turb_highTI"
...
for yawAngle in [250,260,270,280,290,300]:
    for pitchAngle in [0.0]:
        folderName = "wps_1turb_highTI_yaw"+str(yawAngle)
        jobName = folderName
