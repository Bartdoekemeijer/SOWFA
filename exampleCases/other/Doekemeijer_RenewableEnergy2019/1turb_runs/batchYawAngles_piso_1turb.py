...
templateDirectory = "/home/bmdoekemeijer/OpenFOAM/bmdoekemeijer-2.4.0/simulationCases/RE2019/template_piso_1turb"
...
for yawAngle in [230,240,250,260,270,280,290,300,310]:
    for pitchAngle in [0.0]:
        folderName = "piso_yaw"+str(yawAngle)
